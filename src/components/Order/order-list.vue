            ...
            <div class="ml-auto">
              <Modal title="리뷰작성" label="리뷰작성"
                  ...
                  <div data-v-e1812f16="" class="card-text h-full">
                    <div class="space-y-3">
                      <div class="fromGroup relative"><label class="ltr:inline-block rtl:block  input-label"
                          for="pn4">내용</label>
                        <div class="relative"><textarea name="pn4" placeholder="리뷰를 작성해주세요"
                            class="classinput input-control block w-full focus:outline-none pt-3" id="pn4" rows="3"
                ...
                <template v-slot:footer>
                  <Button text="등록" btnClass="btn-outline-dark btn-sm" @click="submitReview" />
