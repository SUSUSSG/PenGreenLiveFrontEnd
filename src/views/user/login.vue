                ...
                <main class="App  relative">
                    ...
                    <div class="loginwrapper">
                        <div class="lg-inner-column">
                            ...
                            <div class="left-column bg-cover bg-no-repeat bg-center " style="background-image: url(src/assets/images/all-img/heart.png);"><div class="flex flex-col h-full justify-center"><div class="flex-1 flex flex-col justify-center items-center"><a href="/"></a></div><div><div class="black-500-title max-w-[525px] mx-auto pb-20 text-center">Unlock your Project<span class="text-white font-bold">performance</span></div></div></div></div>
