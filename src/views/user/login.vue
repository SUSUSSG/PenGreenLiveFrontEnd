                  ...
                  <div class="inner-content h-full flex flex-col bg-white dark:bg-slate-800">
                    <div class="auth-box h-full flex flex-col justify-center">
                      ...
                      <div class="text-left 2xl:mb-10 mb-4">
                        ...
                        <div class="text-slate-500 dark:text-slate-400 text-base">Dashcode 사용을 위해 로그인하세요</div>
                      </div>
                      ...
                      <div class="relative border-b-[#9AA2AF] border-opacity-[16%] border-b pt-6">
                        <div class="absolute inline-block bg-white dark:bg-slate-800 left-1/2 top-1/2 transform -translate-x-1/2 px-4 min-w-max text-sm text-slate-500 dark:text-slate-400 font-normal">SNS 계정으로 간편 로그인/회원가입</div>
                      </div>
                      ...
                      <div class="md:max-w-[345px] mt-6 mx-auto font-normal text-slate-500 dark:text-slate-400 mt-12 uppercase text-sm">아직 회원이 아니신가요?
